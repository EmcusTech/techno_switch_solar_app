...
import 'package:techno_switch_solar_app/features/peripherals/module/controllers/module_info_controller.dart';
  ...
  Widget _infoTile(String label, String value) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label, style: StyleConstants.textDark13w600Style),
          const SizedBox(height: 6),
          Container(
            width: double.infinity,
            padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 14),
