...
class RadioModeController extends PeripheralModeController {
  ...
  void applyCachedData(Map<String, dynamic> data) {
    ...
    radio.advertise =
        (data['advertise'] as bool?) == true
            ? StringConstants.yes
            : StringConstants.no;
    radio.connection =
        (data['connection'] as bool?) == true
            ? StringConstants.yes
            : StringConstants.no;
    radio.service =
        (data['service'] as bool?) == true
            ? StringConstants.yes
            : StringConstants.no;
    radio.programming =
        (data['programming'] as bool?) == true
            ? StringConstants.yes
            : StringConstants.no;
    radio.boot =
        (data['boot'] as bool?) == true
            ? StringConstants.yes
            : StringConstants.no;
  }
  ...
  void loadFromManager() {
    ...
    radio.enabled =
        manager!.isRadioSetupEnabled.value
            ? StringConstants.yes
            : StringConstants.no;
    radio.module =
        manager!.radioSetupModule.value == 0
            ? 'None'
            : StringConstants.bluenrgMB;
    ...
    radio.connection =
        manager!.isRadioSetupConnected.value
            ...
            : StringConstants.no;
    radio.service =
        manager!.isRadioSetupServiced.value
            ? StringConstants.yes
            : StringConstants.no;
    radio.programming =
        manager!.isRadioSetupProgrammed.value
            ...
            : StringConstants.no;
    radio.boot =
        manager!.isRadioSetupBooted.value
            ? StringConstants.yes
            : StringConstants.no;
