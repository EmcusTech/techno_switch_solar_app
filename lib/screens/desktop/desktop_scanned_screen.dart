...
class DesktopScannedScreen extends StatefulWidget {
  final List<dynamic> discoveredDevices;
  final DesktopScanType scanType;
  final bool? isLiveEvent;

  const DesktopScannedScreen({
    super.key,
  ...
  @override
  State<DesktopScannedScreen> createState() => _DesktopScannedScreenState();
}

class _DesktopScannedScreenState extends State<DesktopScannedScreen> {
  @override
              ...
              MaterialPageRoute(
                builder:
                    (context) => AccessCodeScreen(
                      ...
                      //TODO: Add the correct scan type
                    ),
              ),
            );
          },
