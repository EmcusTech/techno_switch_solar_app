...
class SiteService {
  ...
  Map<String, String> validateSiteData({
    ...
    if (saqccRegNumber.trim().isEmpty) {
      errors[StringConstants.saqccregnumber] =
          StringConstants.saqccRegistrationNumberIsRequired;
    }

    if (installerEmail.trim().isNotEmpty &&
        !_isValidEmail(installerEmail.trim())) {
      errors[StringConstants.installeremail] =
          StringConstants.pleaseEnterAValidEmailAddress;
    }
