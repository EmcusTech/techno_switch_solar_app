...
void setRelayEnabledOnManager(BleManager manager, int relayIndex, bool enabled) {
  switch (relayIndex) {
    case 0:
...
void setSounderMainTestOnManager(BleManager manager, int sounderIndex, bool test) {
  switch (sounderIndex) {
    case 0:
      manager.isSounderOneTest.value = test;
      break;
