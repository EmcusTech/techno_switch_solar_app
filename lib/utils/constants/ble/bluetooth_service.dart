...
class BluetoothService {
  ...
  Future<void> startScanning({
    ...
    _scanSub = _ble
        .scanForDevices(
          withServices: [BleConstants.primaryService],
    ...
    connectionStream.listen((update) {
      if (update.connectionState == DeviceConnectionState.connected) {
        _readCharacteristic = QualifiedCharacteristic(
          serviceId: BleConstants.primaryService,
          characteristicId: BleConstants.primaryReadChar,
          deviceId: device.id,
        );

        _writeCharacteristic = QualifiedCharacteristic(
          serviceId: BleConstants.primaryService,
          characteristicId: BleConstants.primaryWriteChar,
          deviceId: device.id,
        );
